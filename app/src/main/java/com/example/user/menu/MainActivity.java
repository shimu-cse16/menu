        ...
        int id = item.getItemId();
         ...
         if (id == R.id.home){
            startActivity(new Intent(this,Home.class));
             ...
             startActivity(new Intent(this,Biriany.class));
         } else if (id == R.id.m2) {
             ...
             startActivity(new Intent(this,sandwicth.class));
             ...
             startActivity(new Intent(this,soup.class));
             ...
             startActivity(new Intent(this,shrimp.class));

         }else if (id == R.id.me4){
             startActivity(new Intent(this,grill.class));
